...
runuser -u docksal "cd /home/docksal; curl -sLf https://spacevim.org/install.sh | bash"
runuser -u docksal "cd /home/docksal; sed -i 's/colorscheme = \".*\"/colorscheme = \"SpaceVim\"/g' /home/docksal/.SpaceVim.d/init.toml"

# Add Vim Twig support
runuser -u docksal "cd /home/docksal; git clone https://github.com/lumiliet/vim-twig.git"
runuser -u docksal "cd /home/docksal; echo '' >> /home/docksal/.SpaceVim.d/init.toml"
runuser -u docksal "cd /home/docksal; echo '# Vim Twig support' >> /home/docksal/.SpaceVim.d/init.toml"
runuser -u docksal "cd /home/docksal; echo '[[custom_plugins]]' >> /home/docksal/.SpaceVim.d/init.toml"
runuser -u docksal "cd /home/docksal; echo 'name = \"lumiliet/vim-twig\"' >> /home/docksal/.SpaceVim.d/init.toml"
runuser -u docksal "cd /home/docksal; echo 'merged = false' >> /home/docksal/.SpaceVim.d/init.toml"

# Install Docksal
echo -e "${green_bg} Step 9 ${NC}${green} Installing Docksal...${NC}"
runuser -u docksal 'cd /home/docksal; curl -fsSL get.docksal.io | zsh'
runuser -u docksal 'cd /home/docksal; newgrp docker'

# Set the proxy ip in the global docksal environment file.
runuser -u docksal "cd /home/docksal; echo 'DOCKSAL_VHOST_PROXY_IP=\"0.0.0.0\"' > /home/docksal/.docksal/docksal.env"
# Reset the system.
runuser -u docksal 'cd /home/docksal; fin reset system'
